...
\par A través de las distintas pruebas realizadas observamos que el algoritmo con mejor desempeño cualquiera sea la dimensión del tablero, es el DFS. Ver tablas en la sección \textbf{Anexo A}. A su vez, entendiendo que para este trabajo los métodos debían ser desinformados y no podíamos aplicar heurísticas, nos pareció interesante comparar los tiempos obtenidos en el punto anterior con los tiempos obtenidos dándole un órden particular a las reglas antes de que el \textit{General Problem Solver} comience a resolver. Básicamente lo que hicimos fue preprocesar las pistas o restricciones del tablero y ordenar el conjujnto de reglas. Una vez ordenadas éstas no son vueltas a tocar y son pasadas al \textit{GPS} para que este las aplique, en ese órden, en cada paso. Ver tablas comparativas en la sección \textbf{Anexo A}.
...
\par Resultó muy interesante tambén la forma de resolver problemas mediante la aplicación del mismo conjunto reglas en forma repetida y variando el orden
...
Nodos frontera & - & 7 \\
\hline
Nodos expandidos & - & 901 \\
\hline
Estados generados & - & 909 \\
\hline
...
Nodos frontera & - & 1 \\
\hline
Nodos expandidos & - & 111 \\
\hline
Estados generados & - & 113 \\
\hline
Profundidad de la solución & 2 (cantidad edificios  & 16 \\
&puestos al corte)&\\
\hline
...
Nodos frontera & - & 0 \\
\hline
Nodos expandidos & - & 1889 \\
\hline
Estados generados & - & 1890 \\
\hline
Profundidad de la solución & 2 (cantidad edificios  & 25 \\
&puestos al corte)&\\
...
&&\\
\hline
Tiempo & \textit{N/A} & 268ms \\
\hline
Nodos frontera & - & 3 \\
\hline
Nodos expandidos & - & 833 \\
\hline
Estados generados & - & 837 \\
\hline
Profundidad de la solución & 2 (cantidad edificios  & 16 \\
&puestos al corte)&\\
\hline
...
Nodos frontera & - & 7 \\
\hline
Nodos expandidos & - & 6528 \\
\hline
Estados generados & - & 6536 \\
\hline
Profundidad de la solución & 2 (cantidad edificios  & 25 \\
&puestos al corte)&\\
